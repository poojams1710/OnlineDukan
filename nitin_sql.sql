...
(19, 'io', 'India', 'Andhra Pradesh', 'mj', 'hh'),
(20, 'io', 'India', 'Andhra Pradesh', 'mj', 'hh'),
(21, 'io', 'India', 'Andhra Pradesh', 'mj', 'hh'),
(22, 'io', 'India', 'Andhra Pradesh', 'mj', '12');
...
(2, 'afasa', 'afasa', 'afasa@test.com'),
(3, 'afasa', 'afasa', 'afasa@test.com'),
(4, 'afgggasa', 'afaggsa', 'afasa@tegggst.com'),
(12, 'afasa', 'afasa', 'afasa@test.com'),
(13, 'afasa', 'afasa', 'afasa@test.com'),
(14, 'afasa', 'afasa', 'afasa@test.com'),
(15, 'nitin', 'ballari', 'nt@test.com'),
(16, 'nitin', 'ballari', 'nt@test.com'),
(17, 'nitin', 'ballari', 'nt@test.com'),
(18, 'nitin', 'ballari', 'nt@test.com'),
(19, NULL, 'balefelari', 'nt@teeest.com'),
(20, NULL, 'balefelari', 'nt@teeest.com'),
(21, NULL, 'balefelari', 'nt@teeest.com'),
(22, NULL, 'balefelabvvvri', 'nt@teeebbbbbt.com'),
(23, NULL, 'afasnjhccva3333', 'pleasework@test.com'),
(24, NULL, 'mharashtra', 'pleasework@test.com'),
(27, NULL, 'bihar', 'pleasework@test.com'),
(28, NULL, 'bihhhar', 'pleasework@test.com'),
(29, NULL, 'bbbbbihhhar', 'pleasework@test.com'),
(30, NULL, 'kl', 'as@gmail.com'),
(31, NULL, 'amol', 'as@gmail.com');
...
(10, 'e71e41aa-795b-4820-add1-01f9987f24fa', '1300.00', 2, 19, 30, 20, NULL, '2021-01-16 23:07:36.774000', '2021-01-16 23:07:36.774000'),
(11, 'a6a53b69-f5f4-404b-8a74-b6a95c31b762', '1400.00', 3, 21, 31, 22, NULL, '2021-01-16 23:14:57.929000', '2021-01-16 23:14:57.929000');
...
(3, NULL, 1, NULL, 10, NULL),
(4, NULL, 1, NULL, 10, NULL),
(5, NULL, 1, NULL, 11, NULL),
(6, NULL, 1, NULL, 11, NULL),
(7, NULL, 1, NULL, 11, NULL);
...
--
ALTER TABLE `itemcategory`
  MODIFY `itemcategoryid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `order_item`
  ...
  ADD CONSTRAINT `FK_product_id` FOREIGN KEY (`product_id`) REFERENCES `item` (`itemid`);
